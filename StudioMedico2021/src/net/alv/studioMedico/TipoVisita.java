...
public final class TipoVisita implements Comparable<TipoVisita> {
	...
	public TipoVisita(String value) {
	...
	@Override
	public int compareTo(TipoVisita other) {
